...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  function App() {
	    ...
	    _this.changeQuery = _this.changeQuery.bind(_this);
	    return _this;
	  }

	  _createClass(App, [{
	    key: 'changeQuery',
	    value: function changeQuery(event) {
	      this.setState({
	    ...
	    value: function search() {
	      ...
	      // const URL = `${BASE_URL}q=${this.state.query}&type=artist`;
	      // console.log('base url', URL)

	      var url = 'https://api.spotify/v1/search?';
	      var fetch_url = url + 'q=' + this.state.query + '&type=artist&limit=1';
	      console.log('fetch_url', fetch_url);

	      var token = 'BQAWlZVK1FqTsY8mDj5qu7E2IvgAvueacfvPl3yp-IsMlFpb06-0Tr8V49O3mXVJrlVQNGv-5XXrEigG5dPoL3bYtG4MXDnmSBPN81ip0zixyDbTsgvdl7V_5zoBs9Hp3zGEsnUwZIMFeT2-4DjP9IPw8HGvBc2Apmjz-I54tzt84hy6Xoc&refresh_token=AQCfONPbB8Ev2WZeK-l3vxbQuUZJBJkRx1GyAk1hku_d5de7oIrshSNuysGdf_OciqZxde4Wb1UUoHDppuWn0j8z6PT9gxTKaVqJyqjapImHObEILtcmMr7MX5SHBEaOGb8';
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'input' },
	          _react2.default.createElement('input', { onKeyPress: this.checkKey.bind(this), onChange: this.changeQuery, className: 'form-control', type: 'text', placeholder: 'Enter in an artist name' }),
	          _react2.default.createElement(
	            'button',
	            { onClick: this.search },
	            'Search'
